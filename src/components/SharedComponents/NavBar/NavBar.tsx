...
const navStyles = {
    ...
    menuButton: {
        marginRight: theme.spacing(2) //default is 8px * 2 == 16px 
    },
    hide: {
        display: 'none'
    },
    ...
    drawerHeader: {
        ...
        ...theme.mixins.toolbar, // spread operator is taking the rest of the properties from theme.mixins.toobaar
        justifyContent: 'flex-end'
    },
    content: {
        transition: theme.transitions.create('margin', { // shiftinh back to original position
    ...
    contentShift: {
        transition: theme.transitions.create('margin', { // shifiting our content
...
export const NavBar = () => {
    const navigate = useNavigate(); // instantiating out useNavigate() hook
